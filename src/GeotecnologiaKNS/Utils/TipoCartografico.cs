...
{
    public static readonly Dictionary<string, string> Mapeamento = new Dictionary<string, string>
    {
        { "SUC", "Sobrep. Unidade de Conservação" },
        { "STI", "Sobrep. Terra Indígena" },
        { "SQ", "Sobrep. Quilombolas" },
        { "SOP", "Sobrep. Outros Perímetos" },
    ...
    {
        return Mapeamento.TryGetValue(valor, out var descricao) ? descricao : valor;
    }
}